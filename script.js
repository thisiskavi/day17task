...
function createcountry({ name, flag, code, capital, region, latitude, longitude }) {
  ...
  <a href="#" class="btn btn-primary" onclick=(block(${latitude},${longitude},${name})) >Weather Info</a>
 <div id=${name}>   </div>
...
function block(lat,lng,name){
  ...
  var WAPI = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lng}&appid=d7369de7d761f134d96aa3e8f332f53f`
